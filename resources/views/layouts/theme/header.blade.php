    ...
    <header class="header navbar navbar-expand-sm">
        ...
        <ul class="navbar-nav theme-brand flex-row  text-center">
            <li class="nav-item theme-logo">
                <a href="index.html">
                    <img src="assets/img/logocode-white.png" class="navbar-logo" alt="logo">
                </a>
            </li>
            <li class="nav-item theme-text">
                <a href="index.html" class="nav-link" style="font-size: 16px; color:#eaebf1" > <b> CODEBREAK SOFT </b></a>
            </li>
                ...
                <div class="dropdown-menu position-absolute" aria-labelledby="userProfileDropdown">
                    <div class="user-profile-section">
                        <div class="media mx-auto">
                            <img src="assets/img/logocodebreak.png" class="img-fluid mr-2" alt="avatar">
                            <div class="media-body">
                                <h5>Favio Garcia</h5>
                                <p>Project Leader</p>
                            </div>
